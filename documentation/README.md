...
- Stream (AC Pro, Ultra, Max, AC, Ultra X) - 47 sensors, 2 binary sensors, 1 number (number is Enhanced Mode only). See the [main README](../README.md#supported-devices) for details.
