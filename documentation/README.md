...
- [PowerPulse 2](entities/powerpulse-2.md) - 16 sensors, 1 binary sensor (`C376`) - a wallbox, read-only, Enhanced Mode only, no PowerOcean required
- [Ocean 2](entities/ocean-2.md) - 93 sensors (`RE11` and `RE17`) - a home battery, one product under two serial prefixes, read-only, Enhanced Mode only
