...
STALE_THRESHOLD_S = (
    35.0  # MQTT data older than this → trigger reconnect + HTTP fallback
)
SMARTPLUG_STALE_THRESHOLD_S = (
    180.0  # Smart Plug app-auth: tolerate sparse telemetry bursts
)
...
HTTP_SUPPLEMENT_INTERVAL_S = (
    60  # Enhanced Mode: HTTP supplement poll for detail sensors
)
...
SMARTPLUG_GET_ALL_KEEPALIVE_S = (
    120.0  # Smart Plug app-auth: periodic full-state refresh
)
CREDENTIAL_REFRESH_CHECK_S = (
    43200.0  # Check every 12h whether credentials need proactive refresh
)
...
POWEROCEAN_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef(
        "grid_phase_b_reactive_power_var",
        "Grid Phase B Reactive Power",
        "var",
        "reactive_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "grid_phase_c_reactive_power_var",
        "Grid Phase C Reactive Power",
        "var",
        "reactive_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "grid_phase_b_apparent_power_va",
        "Grid Phase B Apparent Power",
        "VA",
        "apparent_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "grid_phase_c_apparent_power_va",
        "Grid Phase C Apparent Power",
        "VA",
        "apparent_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        ...
        "diagnostic",
        disabled_by_default=True,
        options=["standby", "running", "stopped"],
    ),
    EcoFlowSensorDef(
        "grid_status",
        "Grid Status",
...
def _build_po_pack_sensors(pack_num: int) -> list[EcoFlowSensorDef]:
    ...
    core = [
        ...
        EcoFlowSensorDef(
            f"{p}_remain_watth",
            f"Pack {pack_num} Remaining Capacity",
            "Wh",
            "energy_storage",
            "measurement",
            "mdi:battery-clock",
    ...
    diagnostic = [
        EcoFlowSensorDef(
            f"{p}_max_cell_temp_c",
            f"Pack {pack_num} Max Cell Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer-chevron-up",
        ...
        EcoFlowSensorDef(
            f"{p}_min_cell_temp_c",
            f"Pack {pack_num} Min Cell Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer-chevron-down",
        ...
        EcoFlowSensorDef(
            f"{p}_env_temp_c",
            f"Pack {pack_num} Environment Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer",
        ...
        EcoFlowSensorDef(
            f"{p}_accu_chg_energy_kwh",
            f"Pack {pack_num} Lifetime Charge Energy",
            "kWh",
            "energy",
            "total_increasing",
            "mdi:battery-charging",
        ...
        EcoFlowSensorDef(
            f"{p}_accu_dsg_energy_kwh",
            f"Pack {pack_num} Lifetime Discharge Energy",
            "kWh",
            "energy",
            "total_increasing",
            "mdi:battery",
        ...
        EcoFlowSensorDef(
            f"{p}_max_mos_temp_c",
            f"Pack {pack_num} Max MOSFET Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer-alert",
        ...
        EcoFlowSensorDef(
            f"{p}_hv_mos_temp_c",
            f"Pack {pack_num} HV MOSFET Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer-alert",
        ...
        EcoFlowSensorDef(
            f"{p}_lv_mos_temp_c",
            f"Pack {pack_num} LV MOSFET Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer-alert",
        ...
        EcoFlowSensorDef(
            f"{p}_ptc_temp_c",
            f"Pack {pack_num} PTC Heater Temp",
            "\u00b0C",
            "temperature",
            "measurement",
            "mdi:thermometer",
        ...
        EcoFlowSensorDef(
            f"{p}_cell_max_vol_mv",
            f"Pack {pack_num} Max Cell Voltage",
            "mV",
            "voltage",
            "measurement",
            "mdi:sine-wave",
        ...
        EcoFlowSensorDef(
            f"{p}_cell_min_vol_mv",
            f"Pack {pack_num} Min Cell Voltage",
            "mV",
            "voltage",
            "measurement",
            "mdi:sine-wave",
        ...
        EcoFlowSensorDef(
            f"{p}_design_cap_mah",
            f"Pack {pack_num} Design Capacity",
            "mAh",
            None,
            "measurement",
            "mdi:battery",
...
DELTA2MAX_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef(
        "ac_chg_rated_power_w",
        "AC Charge Rated Power",
        "W",
        "power",
        "measurement",
        "mdi:lightning-bolt",
    ...
    EcoFlowSensorDef(
        ...
        "mdi:ev-plug-type2",
        disabled_by_default=True,
        options=["none", "ac", "solar", "dc", "unknown"],
    ),
    EcoFlowSensorDef(
        "mppt_chg_state",
        "MPPT Charge State",
    ...
    EcoFlowSensorDef(
        "slave1_remain_cap_mah",
        "Slave 1 Remaining Capacity",
        "mAh",
        None,
        "measurement",
        "mdi:battery-outline",
    ...
    EcoFlowSensorDef(
        "slave1_max_cell_vol_mv",
        "Slave 1 Max Cell Voltage",
        "mV",
        "voltage",
        "measurement",
        "mdi:flash-triangle-outline",
    ...
    EcoFlowSensorDef(
        "slave1_min_cell_vol_mv",
        "Slave 1 Min Cell Voltage",
        "mV",
        "voltage",
        "measurement",
        "mdi:flash-triangle-outline",
    ...
    EcoFlowSensorDef(
        "slave1_max_cell_temp_c",
        "Slave 1 Max Cell Temp",
        "\u00b0C",
        "temperature",
        "measurement",
        "mdi:thermometer-high",
    ...
    EcoFlowSensorDef(
        "slave1_min_cell_temp_c",
        "Slave 1 Min Cell Temp",
        "\u00b0C",
        "temperature",
        "measurement",
        "mdi:thermometer-low",
    ...
    EcoFlowSensorDef(
        "slave1_max_mos_temp_c",
        "Slave 1 Max MOSFET Temp",
        "\u00b0C",
        "temperature",
        "measurement",
        "mdi:thermometer-alert",
    ...
    EcoFlowSensorDef(
        "slave2_remain_cap_mah",
        "Slave 2 Remaining Capacity",
        "mAh",
        None,
        "measurement",
        "mdi:battery-outline",
    ...
    EcoFlowSensorDef(
        "slave2_max_cell_vol_mv",
        "Slave 2 Max Cell Voltage",
        "mV",
        "voltage",
        "measurement",
        "mdi:flash-triangle-outline",
    ...
    EcoFlowSensorDef(
        "slave2_min_cell_vol_mv",
        "Slave 2 Min Cell Voltage",
        "mV",
        "voltage",
        "measurement",
        "mdi:flash-triangle-outline",
    ...
    EcoFlowSensorDef(
        "slave2_max_cell_temp_c",
        "Slave 2 Max Cell Temp",
        "\u00b0C",
        "temperature",
        "measurement",
        "mdi:thermometer-high",
    ...
    EcoFlowSensorDef(
        "slave2_min_cell_temp_c",
        "Slave 2 Min Cell Temp",
        "\u00b0C",
        "temperature",
        "measurement",
        "mdi:thermometer-low",
    ...
    EcoFlowSensorDef(
        "slave2_max_mos_temp_c",
        "Slave 2 Max MOSFET Temp",
        "\u00b0C",
        "temperature",
        "measurement",
        "mdi:thermometer-alert",
...
DELTA2MAX_BINARY_SENSORS: list[EcoFlowBinarySensorDef] = [
    ...
    EcoFlowBinarySensorDef(
        "car_12v_enabled", "12V Enabled", "power", "mdi:car-battery"
    ),
    EcoFlowBinarySensorDef(
        "ups_enabled",
        "UPS Enabled",
...
DELTA2MAX_SWITCHES: list[EcoFlowSwitchDef] = [
    ...
    EcoFlowSwitchDef(
        "car_12v_switch", "12V Output", "car_12v_enabled", "mdi:car-battery"
    ),
    ...
    EcoFlowSwitchDef(
        "ac_auto_on_switch", "AC Auto Restart", "ac_auto_on", "mdi:power-plug"
    ),
    EcoFlowSwitchDef(
...
STREAM_BINARY_SENSORS: list[EcoFlowBinarySensorDef] = [
    EcoFlowBinarySensorDef(
        "ac_outlet_1_enabled", "AC Outlet 1", "power", "mdi:power-socket-eu"
    ),
    EcoFlowBinarySensorDef(
        "ac_outlet_2_enabled", "AC Outlet 2", "power", "mdi:power-socket-eu"
    ),
]
...
STREAM_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef(
        ...
        "mdi:transmission-tower",
        "diagnostic",
        options=["invalid", "grid_in", "not_online", "feed_grid"],
    ),
    EcoFlowSensorDef(
...
STREAMAC5000_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef(
        ...
        "mdi:solar-power",
        suggested_display_precision=0,
        translation_key="third_party_solar_w",
        accessory=True,
    ...
    EcoFlowSensorDef(
        ...
        "mdi:cog-outline",
        "diagnostic",
        options=["self_powered", "intelligent_plus", "custom"],
    ),
    EcoFlowSensorDef(
        "max_charge_soc_pct",
        "Max Charge SoC",
...
STREAMAC5000_SELECTS: list[EcoFlowSelectDef] = [
    EcoFlowSelectDef(
        ...
        "Work Mode",
        "work_mode",
        ("self_powered", "intelligent_plus", "custom"),
        "mdi:cog-outline",
        enhanced_only=True,
    ),
]
...
def filter_defs_for_serial[DefT: _HasKey](
    definitions: list[DefT], device_sn: str
) -> list[DefT]:
...
DELTA3_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef(
        ...
        "Battery Lifetime Charge Energy",
        "kWh",
        "energy",
        "total_increasing",
        "mdi:battery-charging",
    ...
    EcoFlowSensorDef(
        "bms_accu_dsg_energy_kwh",
        "Battery Lifetime Discharge Energy",
        "kWh",
        "energy",
        "total_increasing",
        "mdi:battery",
...
DELTA3_SWITCHES: list[EcoFlowSwitchDef] = [
    ...
    EcoFlowSwitchDef(
        "dc_12v_out_switch", "12V Output", "dc_12v_out_flow", "mdi:car-battery"
    ),
    EcoFlowSwitchDef(
    ...
    EcoFlowSwitchDef(
        "xboost_switch", "X-Boost", "xboost_enabled", "mdi:lightning-bolt"
    ),
...
DELTA3_IDLE_SHUTDOWNS: tuple[tuple[str, str, str, str], ...] = (
    (
        "device_idle_shutdown",
        "Device Idle Shutdown",
        "dev_standby_time_min",
        "mdi:power-off",
    ),
    (
        "ac1_idle_shutdown",
...
POWERSTREAM_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef(
        ...
        "mdi:priority-high",
        "diagnostic",
        options=["power_supply", "battery_storage"],
    ),
    EcoFlowSensorDef(
        "led_brightness",
        "LED Brightness",
...
WAVE3_BINARY_SENSORS: list[EcoFlowBinarySensorDef] = [
    ...
    EcoFlowBinarySensorDef(
        "fault", "Fault", "problem", "mdi:alert-circle", "diagnostic"
    ),
...
WAVE3_NUMBERS: list[EcoFlowNumberDef] = [
    ...
    EcoFlowNumberDef(
        "pet_care_warning_temp_c",
        "Pet Care Warning Temperature",
        "pet_care_warning_temp_c",
        "°C",
        "mdi:thermometer-alert",
        25,
...
# EcoFlow Ocean 2 home battery (`RE11`, `RE17`), its own device type since
# PLAN-135 (#145). Enhanced-only like the WAVE 3 and the PowerPulse 2 above:
# the Developer API refuses the unit with error 1006 and the account channel
# carries no product name, so the two serial prefixes are the whole
# classification (ADR-028). The two prefixes are the 10 kW and the 12 kW
# rating of one product with one message family, so one type serves both.
#
# The field map rests on one owner's seven-hour diagnostics download (69
# frames, none truncated) read against jensfr1's own Ocean 2 integration;
# every value published here is one that download carries. The keys reuse
# the PowerOcean's where the reading is the same thing, so the two devices
# render identically and the Energy Dashboard mapping carries over. Every
# entry is `enhanced_only`, because no other channel ever carries this
# device's telemetry.
#
# Deliberately absent: the feed-in ceiling the display upload carries beside
# the readings (ADR-028 decision 5: it is the app's own setting, echoed back,
# not a measurement). Battery modules are keyed on their index in the module
# report, never on their serial, and the report is a backlog of heartbeats,
# so the number of records in a frame is not the number of modules. Two
# modules are on file; six are defined so a larger installation fills in,
# and packs 3 to 6 are disabled by default like the PowerOcean's packs 2 to
# 5. Inverter-side phase readings and PV string 3 (unpopulated on the one
# installation on file) are disabled by default as well.
OCEAN2_SENSORS: list[EcoFlowSensorDef] = [
    ...
    # Derived by the coordinator from the signed battery power, exactly as
    # for the PowerOcean, so the same entity exists on both.
    EcoFlowSensorDef(
        "batt_charge_discharge_state",
        "Battery Charge/Discharge State",
        None,
    ...
    EcoFlowSensorDef(
        "inv_phase_a_voltage_v",
        "Inverter Phase A Voltage",
        "V",
        "voltage",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_a_current_a",
        "Inverter Phase A Current",
        "A",
        "current",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_a_active_power_w",
        "Inverter Phase A Active Power",
        "W",
        "power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_a_reactive_power_var",
        "Inverter Phase A Reactive Power",
        "var",
        "reactive_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_a_apparent_power_va",
        "Inverter Phase A Apparent Power",
        "VA",
        "apparent_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_b_voltage_v",
        "Inverter Phase B Voltage",
        "V",
        "voltage",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_b_current_a",
        "Inverter Phase B Current",
        "A",
        "current",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_b_active_power_w",
        "Inverter Phase B Active Power",
        "W",
        "power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_b_reactive_power_var",
        "Inverter Phase B Reactive Power",
        "var",
        "reactive_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_b_apparent_power_va",
        "Inverter Phase B Apparent Power",
        "VA",
        "apparent_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_c_voltage_v",
        "Inverter Phase C Voltage",
        "V",
        "voltage",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_c_current_a",
        "Inverter Phase C Current",
        "A",
        "current",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_c_active_power_w",
        "Inverter Phase C Active Power",
        "W",
        "power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_c_reactive_power_var",
        "Inverter Phase C Reactive Power",
        "var",
        "reactive_power",
        "measurement",
        "mdi:sine-wave",
    ...
    EcoFlowSensorDef(
        "inv_phase_c_apparent_power_va",
        "Inverter Phase C Apparent Power",
        "VA",
        "apparent_power",
        "measurement",
        "mdi:sine-wave",
...
def _build_ocean2_pack_sensors(pack_num: int) -> list[EcoFlowSensorDef]:
    """Build the seven sensor definitions of one Ocean 2 battery module.

    Packs 1 and 2: SoC, power, SoH, cycles and remaining energy enabled,
    the two diagnostics disabled. Packs 3-6: everything disabled, the same
    shape as the PowerOcean's packs 2-5.
    """
    p = f"pack{pack_num}"
    enabled = pack_num <= 2
    return [
...
for _pack_num in range(1, 7):
    OCEAN2_SENSORS.extend(_build_ocean2_pack_sensors(_pack_num))

# The Ocean 2 reports no lifetime counters this integration reads, so all
# six energy totals are integrated from power, the battery pair included
# (the PowerOcean takes those two from its API, which this device has none
# of).
