...
DELTA2MAX_SENSORS: list[EcoFlowSensorDef] = [
    ...
    EcoFlowSensorDef("ems_chg_state", "EMS Charge State", None, "enum", None, "mdi:battery-charging-outline", disabled_by_default=True, options=["idle", "charging", "discharging", "standby"]),
