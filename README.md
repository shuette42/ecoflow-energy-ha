...
|:---|:---|:---:|:---:|:---:|:---|
| **PowerOcean** - Home Battery | `HJ31` `HJ32` `HJ35` `HJ36` `HJ37` `J32B` `J327`\* `J329` `J32D`\* `J32E`\* | 227 + 5 binary | 2 numbers, 1 select (Enhanced only) | 6 (solar, grid import/export, battery charge/discharge, home) | ~30 s standard / ~3 s enhanced |
